...
os.chdir("oidv6")
#os.chdir(os.path.join("oidv6", "Dataset"))
#os.chdir(os.path.join("oidv6", "multidata"))
...
allowed_folders = ["train", "test", "validation"]
#

# for all train, validation and test folders
for DIR in DIRS:
    if os.path.isdir(DIR) and DIR in allowed_folders:
